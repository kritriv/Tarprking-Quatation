...
router.post('/add-subproduct', authMiddleware(getPermissions('HIGH')), postSingleSubProduct);
...
router.put('/:id', authMiddleware(getPermissions('HIGH')),  updateSingleSubProduct);
